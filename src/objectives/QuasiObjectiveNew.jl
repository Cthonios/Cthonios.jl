function QuasiStaticObjectiveNew()
    return QuadratureLevelObjective(energy, residual, stiffness)
end

struct QuasiStaticObjectiveCacheNew{
    A, O, P,
...
function QuasiStaticObjectiveCacheNew(
    # objective,
    sim
)
    objective = QuasiStaticObjectiveNew()
    ...
    return QuasiStaticObjectiveCacheNew(
...
# objective hooks
function gradient(o::QuasiStaticObjectiveCacheNew, U, p)
    RT = eltype(U)
...
# integrator hooks
function initialize!(o::QuasiStaticObjectiveCacheNew)
    return nothing
end

function step!(o::QuasiStaticObjectiveCacheNew, solver)
    Uu = o.solution
    p = o.parameters
...
# logging hooks
function _step_begin_banner(o::QuasiStaticObjectiveCacheNew)
    p = o.parameters
...
function _step_end_banner(o::QuasiStaticObjectiveCacheNew)
...
function write_standard_outputs(pp, n, o::QuasiStaticObjectiveCacheNew)
    p = o.parameters
