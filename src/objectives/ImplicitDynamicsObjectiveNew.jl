function ImplicitDynamicsObjectiveNew()
    return QuadratureLevelObjective(energy, residual, stiffness)
end

struct ImplicitDynamicsObjectiveCacheNew{
    A, O, P,
...
function ImplicitDynamicsObjectiveCacheNew(sim, β=0.25, γ=0.5)
    ...
    return ImplicitDynamicsObjectiveCacheNew(
...
function gradient(o::ImplicitDynamicsObjectiveCacheNew, U, p)
    RT = eltype(U)
...
function hessian(o::ImplicitDynamicsObjectiveCacheNew, U, p)
...
function initialize!(o::ImplicitDynamicsObjectiveCacheNew)
    # set initial energy
...
function step!(o::ImplicitDynamicsObjectiveCacheNew, solver)
...
function _correct!(o::ImplicitDynamicsObjectiveCacheNew)
    # TODO
    u = o.solution
    v = o.solution_rate
...
function _predict!(o::ImplicitDynamicsObjectiveCacheNew)
...
function _step_begin_banner(o::ImplicitDynamicsObjectiveCacheNew)
    p = o.parameters
